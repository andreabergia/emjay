...
use crate::{
    backend::{self, GeneratedMachineCode, MachineCodeGenerator},
...
mod test {
    ...
    fn can_compile_trivial_function() {
        let program = parse_program("fn the_answer() { let a = 42; return 1 + a; }").unwrap();
